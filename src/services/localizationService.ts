...
export const TRANSLATIONS: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    // Extended UI Keys
    tab_companions: 'AI Companions',
    continue_reading: 'CONTINUE READING',
    min_remaining: 'MIN REMAINING',
    your_companions: 'Your AI Companions',
    see_all: 'See all',
    explore_more: 'Explore More',
    explore_subtitle: 'Meet all 7 Apostles & Biblical mentors',
    more_for_you: 'More for you',
    converse: 'Converse',
    share_app_title: 'Share the Bible App',
    share_app_sub: 'Invite your friends to connect with you here, in Biblical community.',
    share_now: 'Share Now',
    dismiss: 'Dismiss',
    chats_title: 'Chats',
    find_church: 'Find Your Church',
    saved_card: 'Saved',
    prayer_card: 'Prayer',
    giving_card: 'Giving',
  ...
  es: {
    ...
    // Extended UI Keys
    tab_companions: 'Compañeros IA',
    continue_reading: 'CONTINUAR LEYENDO',
    min_remaining: 'MIN RESTANTES',
    your_companions: 'Tus Compañeros IA',
    see_all: 'Ver todos',
    explore_more: 'Explorar Más',
    explore_subtitle: 'Conoce a todos los Apóstoles y mentores',
    more_for_you: 'Más para ti',
    converse: 'Conversar',
    share_app_title: 'Comparte la App de la Biblia',
    share_app_sub: 'Invita a tus amigos a conectarse en comunidad bíblica.',
    share_now: 'Compartir Ahora',
    dismiss: 'Descartar',
    chats_title: 'Chats',
    find_church: 'Encuentra tu Iglesia',
    saved_card: 'Guardados',
    prayer_card: 'Oración',
    giving_card: 'Ofrenda',
    my_reflection: 'Mi Reflexión',
  },
  ...
  tw: {
    ...
    // Extended UI Keys
    tab_companions: 'Asomafoɔ',
    continue_reading: 'TOA SO KENKAN',
    min_remaining: 'SIMA A AKA',
    your_companions: 'Wo Honhom mu Akwankyerɛfoɔ',
    see_all: 'Hwɛ ne nyinaa',
    explore_more: 'Hwehwɛ Pii',
    explore_subtitle: 'Hyia Asomafoɔ no nyinaa',
    more_for_you: 'Pii ma wo',
    converse: 'Kasa',
    share_app_title: 'Kyɛ Twerɛ Kronkron App no',
    share_app_sub: 'To nsa frɛ nnamfonom ma wɔmmɛka ho wɔ Twerɛ Kronkron nkabom mu.',
    share_now: 'Kyɛ Seesei',
    dismiss: 'Gyae',
    chats_title: 'Nkabom',
    find_church: 'Hwehwɛ W’Asɔre',
    saved_card: 'Nea Wakora',
    prayer_card: 'Mpaebɔ',
    giving_card: 'Akyɛdeɛ',
    my_reflection: 'Me Nsusuwii',
  },
  ...
  sw: {
    ...
    // Extended UI Keys
    tab_companions: 'Wenzako wa AI',
    continue_reading: 'ENDELEA KUSOMA',
    min_remaining: 'DAKIKA ZIMEBAKI',
    your_companions: 'Washauri Wako wa Biblia',
    see_all: 'Ona yote',
    explore_more: 'Gundua Zaidi',
    explore_subtitle: 'Kutana na Mitume na washauri wote',
    more_for_you: 'Zaidi kwa ajili yako',
    converse: 'Zungumza',
    share_app_title: 'Shiriki Programu ya Biblia',
    share_app_sub: 'Waalike marafiki kuungana katika jumuiya ya kibiblia.',
    share_now: 'Shiriki Sasa',
    dismiss: 'Puuza',
    chats_title: 'Mazungumzo',
    find_church: 'Tafuta Kanisa Lako',
    saved_card: 'Iliyohifadhiwa',
    prayer_card: 'Maombi',
    giving_card: 'Utoaji',
    my_reflection: 'Tafakari Yangu',
  }
};
